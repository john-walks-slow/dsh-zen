...
export const zh = {
	...
	"settings.showPrevReply": "显示上轮回复",
	"settings.showCurrentReply": "显示本轮最新回复",
...
export const en = {
	...
	"settings.showPrevReply": "Show last reply",
	"settings.showCurrentReply": "Show current round reply",
